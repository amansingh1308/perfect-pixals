...
const Business = () => {
   ...
   return (
      <>
         <div className="bgBusiness m-6 ">
            <div className='max-w-7xl mx-auto px-4 '>
               <div className='grid grid-cols-12'>
                  <div className='col-span-12 flex justify-center items-center bgHeading  '>
                     <h1 className='text-center textUniversal font-brygada font-semibold text-[60px] '>Business</h1>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div className='max-w-7xl mx-auto px-4'>
            <div className='grid grid-cols-12'>
               ...
               <div className='col-span-8'>
                  <h1 className='font-brygada text-[30px] font-bold text-[#242424] mb-5'>Business Templates</h1>
